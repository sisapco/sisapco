...
public class ControlPagosController {
		...
		//Crear Control pagos
		@PostMapping("/crearcontrolpagos")
		public String crearControlPagos(@Valid @ModelAttribute("controlpagosForm")ControlPagos controlPagos,BindingResult result, Authentication authenticationnn,  ModelMap model, HttpServletRequest req, HttpServletResponse resp, 
