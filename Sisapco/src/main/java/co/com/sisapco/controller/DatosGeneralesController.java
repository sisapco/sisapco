...
public class DatosGeneralesController {
	...
	//Crear datos generales
		...
		public String crearDatosGenerales(@Valid @ModelAttribute("datosgeneralesForm")DatosGenerales datosGenerales,BindingResult result, Authentication authenticationnn, 
			...
			if(result.hasErrors()) {
				...
				try {
					datosGenerales.setDatosperLog(String.valueOf(usuId));
